...
const TAX_YEARS = Array.from({ length: 5 }, (_, i) => new Date().getFullYear() - 1 + i);
      ...
      <ThemedView style={styles.container}>
        <SafeAreaView edges={['top', 'left', 'right']} style={styles.safeArea}>
          <View style={styles.loadingContainer}>
            <ThemedText type="default" themeColor="textSecondary">Loading...</ThemedText>
          </View>
        </SafeAreaView>
      </ThemedView>
    );
    ...
    <ThemedView style={styles.container}>
      <SafeAreaView edges={['top', 'left', 'right']} style={styles.safeArea}>
        ...
        <View style={styles.header}>
          ...
          <ThemedText type="title" style={styles.headerTitle}>Tax Configuration</ThemedText>
        </View>

        <ScrollView contentContainerStyle={styles.scroll}>
          {/* Filing Status */}
          <View style={styles.section}>
            <ThemedText type="callout" style={styles.sectionTitle}>Filing Status</ThemedText>
            <ThemedText type="small" themeColor="textSecondary" style={styles.sectionSubtitle}>
              Your tax filing status determines your tax brackets and standard deduction.
            </ThemedText>
                ...
                <View key={status.value}>
                  <Pressable
                    ...
                    <View style={[styles.radio, {
                      borderColor: filingStatus === status.value ? theme.primary : theme.inputBorder,
                      backgroundColor: filingStatus === status.value ? theme.primary : 'transparent',
                    }]}>
                      {filingStatus === status.value && (
                        <SymbolView name={{ ios: 'checkmark', android: 'check', web: 'check' }} size={12} tintColor="#fff" />
                      )}
                    </View>
                    <ThemedText type="default" style={{ fontWeight: filingStatus === status.value ? '600' : '400' }}>
                      {status.label}
                    </ThemedText>
                  </Pressable>
          ...
          {/* State */}
          <View style={styles.section}>
            <ThemedText type="callout" style={styles.sectionTitle}>State</ThemedText>
            <ThemedText type="small" themeColor="textSecondary" style={styles.sectionSubtitle}>
              ...
              {US_STATES.map((state, index) => (
                <View key={state.code}>
                  <Pressable
                    ...
                    style={styles.optionRow}>
                    <View style={[styles.radio, {
                      borderColor: selectedState === state.code ? theme.primary : theme.inputBorder,
                      backgroundColor: selectedState === state.code ? theme.primary : 'transparent',
                    }]}>
                      {selectedState === state.code && (
                        <SymbolView name={{ ios: 'checkmark', android: 'check', web: 'check' }} size={12} tintColor="#fff" />
                      )}
                    </View>
                    <ThemedText type="default" style={{ fontWeight: selectedState === state.code ? '600' : '400' }}>
          ...
          {/* Tax Year */}
          <View style={styles.section}>
            <ThemedText type="callout" style={styles.sectionTitle}>Tax Year</ThemedText>
            <ThemedText type="small" themeColor="textSecondary" style={styles.sectionSubtitle}>
              ...
              {TAX_YEARS.map((year, index) => (
                <View key={year}>
                  <Pressable
                    ...
                    style={styles.optionRow}>
                    <View style={[styles.radio, {
                      borderColor: taxYear === year ? theme.primary : theme.inputBorder,
                      backgroundColor: taxYear === year ? theme.primary : 'transparent',
                    }]}>
                      {taxYear === year && (
                        <SymbolView name={{ ios: 'checkmark', android: 'check', web: 'check' }} size={12} tintColor="#fff" />
                      )}
                    </View>
                    <ThemedText type="default" style={{ fontWeight: taxYear === year ? '600' : '400' }}>
