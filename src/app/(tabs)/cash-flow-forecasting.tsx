      ...
      <View style={styles.safe}>
        ...
        >
            ...
            <NeumorphicCard style={styles.card}>
              ...
              >
                <SymbolView
                  ...
                  size={22}
                  tintColor={
                    includeTaxReserve ? theme.primary : theme.placeholder
                  }
                />
          ...
          <View style={styles.infoBox}>
            ...
            >
              Forecasts are based on historical income and expense patterns.
