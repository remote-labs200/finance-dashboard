        ...
        >
          ...
          {currentDevice && (
            <View style={styles.section}>
              ...
              <NeumorphicCard
                style={[styles.deviceCard, { borderColor: theme.primary }]}
              >
                <View style={styles.deviceTop}>
                  ...
                  <View style={styles.deviceInfo}>
                    ...
                    <ThemedText type="small" themeColor="textSecondary">
                      {currentDevice.type} — {currentDevice.os}
                    </ThemedText>
                  </View>
          ...
          {otherDevices.length > 0 && (
            <View style={styles.section}>
              ...
              {otherDevices.map((device) => (
                <NeumorphicCard key={device.id} style={styles.deviceCard}>
                  <View style={styles.deviceTop}>
                    <SymbolView
                      name={
                        device.type === "Web"
          ...
          <View style={styles.infoBox}>
            ...
            >
              Devices shown are sessions authenticated with your account.
...
const styles = StyleSheet.create({
  ...
  deviceCard: { padding: Spacing.three, gap: Spacing.two },
  deviceTop: { flexDirection: "row", alignItems: "center", gap: Spacing.two },
  deviceInfo: { flex: 1, gap: 1 },
  badge: { paddingVertical: 2, paddingHorizontal: Spacing.two },
