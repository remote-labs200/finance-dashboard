...
const LOGS: LogEntry[] = [
  ...
  },
  {
    ...
    detail: "Authenticator app code verified",
    date: "Today, 08:32 AM",
  },
  {
    id: "4",
  ...
  },
  {
    ...
    type: "export",
    title: "Data Export",
    detail: "CSV export of all transactions (247 records)",
  ...
  },
  {
    ...
    type: "sign-out",
    title: "Sign-Out",
    detail: "Signed out from Account screen",
    date: "27 Jul 2026, 06:00 PM",
  },
  {
    id: "7",
    type: "device",
    title: "New Device Connected",
    detail: "MacBook Pro, macOS 15.1",
  ...
  },
  {
    ...
    detail: "Email link authentication",
    date: "22 Jul 2026, 07:45 AM",
...
function LogIcon({ type }: { type: LogEntry["type"] }) {
  ...
  const config: Record<
    string,
    { ios: string; android: string; web: string; color: string }
  > = {
    "sign-in": {
...
export default function SecurityLogsScreen() {
  ...
  // Inline filter type
  const [activeFilter, setActiveFilter] = useState<"all" | LogEntry["type"]>(
    "all",
  );
    ...
    <ThemedView style={styles.container}>
      <View style={styles.safe}>
        ...
        >
          ...
          {/* Info banner */}
          <NeumorphicCard style={styles.infoBanner}>
            <SymbolView
              name={{
            ...
            >
              Security logs are stored locally and never transmitted. Only the
              last 90 days are retained.
            </ThemedText>
          </NeumorphicCard>
...
const styles = StyleSheet.create({
  ...
  logCard: { padding: Spacing.three, gap: Spacing.one },
