      ...
      <View style={styles.safe}>
        ...
        >
          ...
          <NeumorphicCard style={styles.card}>
            <NeumorphicPressable
              inset={isEnabled && method === "app"}
              onPress={() =>
                handleEnable(isEnabled && method === "app" ? "none" : "app")
              }
            ...
            >
              <SymbolView
                ...
                size={24}
                tintColor={
                  isEnabled && method === "app" ? theme.success : theme.text
                }
              />
            ...
            />
            <NeumorphicPressable
              inset={isEnabled && method === "sms"}
              onPress={() =>
                handleEnable(isEnabled && method === "sms" ? "none" : "sms")
              }
              style={styles.methodRow}
            >
              <SymbolView
                ...
                size={24}
                tintColor={
                  isEnabled && method === "sms" ? theme.success : theme.text
                }
              />
              <View style={styles.methodBody}>
                <ThemedText type="default" style={{ fontWeight: "500" }}>
          ...
          {isEnabled && (
            ...
            >
              ...
              <View style={styles.recoveryBody}>
                <ThemedText
                  type="default"
                  style={{ fontWeight: "600", color: theme.warning }}
                >
                  Recovery Codes
                </ThemedText>
                <ThemedText
                  type="small"
                  style={{ color: theme.warning, lineHeight: 18 }}
                >
                  Save your recovery codes in a secure place. If you lose access
                  to your 2FA method, recovery codes are the only way back in.
                </ThemedText>
                <NeumorphicButton
                  variant="ghost"
          ...
          <View style={styles.infoBox}>
            ...
            >
              Two-factor authentication adds an extra verification step during
              sign-in. Once enabled, you'll need your password and a
