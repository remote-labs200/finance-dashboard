      ...
      items: [
        {
          ...
          onPress: () => navigateTo('/(tabs)/(main)/personal-profile'),
        },
        {
          ...
          onPress: () => navigateTo('/(tabs)/(main)/business-info'),
        },
        {
          ...
          onPress: () => navigateTo('/(tabs)/(main)/tax-profile'),
        },
        {
          icon: { ios: 'calendar', android: 'calendar_month', web: 'calendar_month' },
          label: 'Accounting Year',
          description: 'Custom financial year start date settings.',
          onPress: () => navigateTo('/(tabs)/(main)/accounting-year'),
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          onPress: () => navigateTo('/(tabs)/(main)/settings'),
        },
        {
