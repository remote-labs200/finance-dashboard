/**
 * SplashLogo — Custom techno-geometric "SMOOTHTAX" wordmark
 *
...
function TagSegment({ w, h, x, y, c }: { w: number; h: number; x: number; y: number; c: string }) {
  return (
    <View
      style={{
        position: 'absolute',
...
function TagChar({ children }: { children: React.ReactNode }) {
  return <View style={{ width: 14, height: 10, position: 'relative' }}>{children}</View>;
}
...
function Tagline({ color }: { color: string }) {
  ...
  return (
    <View style={{ flexDirection: 'row', alignItems: 'flex-end', height: 12 }}>
      {/* Y */}
      <TagChar>
        <T w={14} h={2} x={0} y={0} /><T w={2} h={12} x={6} y={2} /><T w={14} h={2} x={0} y={12} />
      </TagChar>
      {/* o */}
      <TagChar>
        <T w={2} h={8} x={0} y={0} /><T w={10} h={2} x={2} y={0} /><T w={2} h={8} x={10} y={0} /><T w={10} h={2} x={2} y={6} />
      </TagChar>
      {/* u */}
      <TagChar>
        <T w={2} h={8} x={0} y={0} /><T w={10} h={2} x={2} y={6} /><T w={2} h={8} x={10} y={0} />
      </TagChar>
      {/* r */}
      <TagChar>
        <T w={2} h={8} x={0} y={0} /><T w={8} h={2} x={2} y={0} />
      </TagChar>
      <TagSpace />
      {/* i */}
      <TagChar>
        <T w={2} h={2} x={4} y={0} /><T w={2} h={8} x={4} y={2} /><T w={6} h={2} x={2} y={8} />
      </TagChar>
      {/* n */}
      <TagChar>
        <T w={2} h={8} x={0} y={0} /><T w={8} h={2} x={2} y={0} /><T w={2} h={8} x={8} y={2} />
      </TagChar>
      {/* c */}
      <TagChar>
        <T w={2} h={8} x={0} y={0} /><T w={8} h={2} x={2} y={0} /><T w={8} h={2} x={2} y={6} />
      </TagChar>
      {/* o */}
      <TagChar>
        <T w={2} h={8} x={0} y={0} /><T w={10} h={2} x={2} y={0} /><T w={2} h={8} x={10} y={0} /><T w={10} h={2} x={2} y={6} />
      ...
      {/* m */}
      <TagChar>
        <T w={2} h={8} x={0} y={0} /><T w={2} h={8} x={6} y={0} /><T w={2} h={8} x={12} y={0} />
        <T w={4} h={2} x={2} y={0} /><T w={4} h={2} x={8} y={0} />
      </TagChar>
      {/* e */}
      <TagChar>
        <T w={2} h={8} x={0} y={0} /><T w={10} h={2} x={2} y={0} /><T w={8} h={2} x={2} y={3} /><T w={10} h={2} x={2} y={6} />
      </TagChar>
      {/* , */}
      <TagChar>
        <T w={2} h={3} x={4} y={7} />
      ...
      {/* s */}
      <TagChar>
        <T w={8} h={2} x={2} y={0} /><T w={2} h={3} x={0} y={2} /><T w={8} h={2} x={2} y={3} /><T w={2} h={3} x={8} y={5} /><T w={8} h={2} x={2} y={6} />
      </TagChar>
      {/* m */}
      <TagChar>
        <T w={2} h={8} x={0} y={0} /><T w={2} h={8} x={6} y={0} /><T w={2} h={8} x={12} y={0} />
      ...
      {/* t */}
      <TagChar>
        <T w={8} h={2} x={2} y={0} /><T w={2} h={8} x={4} y={2} />
      </TagChar>
      {/* h */}
      <TagChar>
        <T w={2} h={8} x={0} y={0} /><T w={10} h={2} x={2} y={3} /><T w={2} h={8} x={10} y={0} />
      </TagChar>
      {/* e */}
      <TagChar>
        <T w={2} h={8} x={0} y={0} /><T w={10} h={2} x={2} y={0} /><T w={8} h={2} x={2} y={3} /><T w={10} h={2} x={2} y={6} />
      ...
      {/* d */}
      <TagChar>
        <T w={2} h={8} x={0} y={0} /><T w={2} h={8} x={10} y={0} /><T w={10} h={2} x={2} y={0} /><T w={10} h={2} x={2} y={6} /><T w={4} h={2} x={8} y={8} />
      </TagChar>
      {/* . */}
      <TagChar>
        <T w={2} h={2} x={4} y={8} />
  ...
  return (
    <View style={[styles.wrapper, compact && { transform: [{ scale: 0.6 }] }]}>
      ...
      <View style={styles.taglineSection}>
        <View style={[styles.divider, { backgroundColor: wordmarkColor + '40' }]} />
